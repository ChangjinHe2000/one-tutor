...
> 你的私人 AI 学习教练：一个可安装到 Codex 的自适应学习 Skill。

**OneTutor 是一个开源 Codex Skill，不是预置题库，也不是独立的在线课程平台。**

它可以把你的笔记、教材、PDF、DOCX、课程资料或现有题库，变成一套会持续了解你的私人学习系统：自动出题、收集答案与信心程度、分析错误、识别薄弱知识点，并安排下一次复习。
...
[查看 OneTutor Skill 定义](one-tutor/SKILL.md)
